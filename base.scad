...
use <./SBC_Case_Builder/SBC_Model_Framework/sbc_models.scad>;
include <./SBC_Case_Builder/sbc_case_builder_library.scad>;
include <./SBC_Case_Builder/SBC_Model_Framework/sbc_models.cfg>;
include <./SBC_Case_Builder/sbc_case_builder_accessories.cfg>;
...
Rack_Bay1 =
    "none"; //  ["none", "c1+", "c2", "c4", "hc4", "c5", "xu4", "xu4q", "mc1", "hc1", "n1", "n2", "n2+", "n2l", "n2lq",
            ...
            //  "sweetpotato", "tritium-h2+", "tritium-h3", "tritium-h5", "solitude", "alta", "atomicpi", "visionfive2",
            //  "visionfive2q", "bpif3", "milk-v_duos", "licheerv+dock", "rak19007", "cnano-avr128da48", "nodemcu-32s",
            //  "cs-solarmeter", "feather-m0_express", "feather-m0_wifi", "feather-m4_express"]
...
accessory_name =
    "none"; // ["none", "hk_uart", "c4_shell_boombox", "c4_desktop_lcd3.5", "c4_deskboom_lcd3.5",
            ...
            // "h3_panel_nas", "h3_ultimate", "h3_ultimate2", "h4_panel_nas", "show2_shell", "rpi5_m2hat",
            // "rpi5_bottom_m2hat", "rock5b", "adapter_mini-stx_m1s", "nas", "cs_solarmeter", "n2l_env_sensors",
...
top_standoff_hole_size = 4.5;    //[0:.01:5]
...
top_front_right_adjust = -17.65;   //[-30:.01:30]
...
pcb_z = sbc_model == "ssi-eeb" || sbc_model == "ssi-ceb" || sbc_model == "atx" || sbc_model == "micro-atx" ||
                sbc_model == "dtx" || sbc_model == "flex-atx" || sbc_model == "mini-dtx" || sbc_model == "mini-itx" ||
                sbc_model == "mini-itx_thin" || sbc_model == "mini-stx" || sbc_model == "mini-stx_thin" ||
                sbc_model == "nano-itx" || sbc_model == "nuc" || sbc_model == "pico-itx"
            ? pcb_z_orig + standard_motherboard_thickness
            : pcb_z_orig;
width = case_design == "panel_nas" && pcb_width <= 100
            ? pcb_width + 2 * (sidethick + gap) + case_offset_x + (101.6 - pcb_width)
...
depth = case_design == "panel_nas" ? pcb_depth + 2 * (wallthick + gap) + case_offset_y + 147 - pcb_depth + hd_y_position
...
bottom_height =
    (case_design == "tray" || case_design == "tray_vu5" || case_design == "tray_vu7" || case_design == "tray_sides")
        ? pcb_z + pcb_bmaxz + floorthick + case_offset_bz + 4
        : pcb_z + pcb_bmaxz + floorthick + case_offset_bz;
case_z = case_design == "panel_nas" ? bottom_height + top_height + hd_z_position + (hd_bays * (hd_space + 26.1))
...
top_standoff = [
	top_standoff_size, top_standoff_diameter, 18, top_standoff_hole_size, top_standoff_support_size,
	top_standoff_support_height, top_standoff_type, top_standoff_pillar, top_rear_left_support, top_standoff_reverse,
	top_standoff_insert, top_standoff_insert_dia,
	top_standoff_insert_height
];

bottom_standoff = [
	bottom_standoff_size, bottom_standoff_diameter, 6, bottom_standoff_hole_size, bottom_standoff_support_size,
	bottom_standoff_support_height, bottom_standoff_type, bottom_standoff_pillar, bottom_rear_left_support,
	bottom_standoff_reverse, bottom_standoff_insert, bottom_standoff_insert_dia,
	bottom_standoff_insert_height
];

ext_top_standoff = [
	ext_top_standoff_size, ext_top_standoff_diameter, 18, ext_top_standoff_hole_size, ext_top_standoff_support_size,
	ext_top_standoff_support_height, ext_top_standoff_type, ext_top_standoff_pillar, ext_top_rear_left_support,
	ext_top_standoff_reverse, ext_top_standoff_insert, ext_top_standoff_insert_dia,
	ext_top_standoff_insert_height
];

ext_bottom_standoff = [
	ext_bottom_standoff_size, ext_bottom_standoff_diameter, 6, ext_bottom_standoff_hole_size,
	ext_bottom_standoff_support_size, ext_bottom_standoff_support_height, ext_bottom_standoff_type,
	ext_bottom_standoff_pillar, ext_bottom_rear_left_support, ext_bottom_standoff_reverse, ext_bottom_standoff_insert,
	ext_bottom_standoff_insert_dia,
	ext_bottom_standoff_insert_height
];

multipcb_top_standoff = [
	multipcb_top_standoff_size, multipcb_top_standoff_diameter, 18, multipcb_top_standoff_hole_size,
	multipcb_top_standoff_support_size, multipcb_top_standoff_support_height, multipcb_top_standoff_type,
	multipcb_top_standoff_pillar, multipcb_top_rear_left_support, multipcb_top_standoff_reverse,
	multipcb_top_standoff_insert, multipcb_top_standoff_insert_dia,
	multipcb_top_standoff_insert_height
];

multipcb_bottom_standoff = [
	multipcb_bottom_standoff_size, multipcb_bottom_standoff_diameter, 6, multipcb_bottom_standoff_hole_size,
	multipcb_bottom_standoff_support_size, multipcb_bottom_standoff_support_height, multipcb_bottom_standoff_type,
	multipcb_bottom_standoff_pillar, multipcb_bottom_rear_left_support, multipcb_bottom_standoff_reverse,
	multipcb_bottom_standoff_insert, multipcb_bottom_standoff_insert_dia,
...
rack_bay_rotation = [
	rack_bay1_rotation, rack_bay2_rotation, rack_bay3_rotation, rack_bay4_rotation, rack_bay5_rotation,
	rack_bay6_rotation
];
...
rack_bay_rear_fan = [
	rack_bay1_rear_fan, rack_bay2_rear_fan, rack_bay3_rear_fan, rack_bay4_rear_fan, rack_bay5_rear_fan,
	rack_bay6_rear_fan
];
rack_bay_rear_conduit = [
	rack_bay1_rear_conduit, rack_bay2_rear_conduit, rack_bay3_rear_conduit, rack_bay4_rear_conduit,
...
module base(sbc_off, accessory_name)
{
	...
	if (view == "platter")
	{
		...
		if (case_design == "tray" || case_design == "tray_vu5" || case_design == "tray_vu7" ||
		...
		if (case_design == "adapter_mini-stx_thin" || case_design == "adapter_mini-stx" ||
		    case_design == "adapter_mini-itx_thin" || case_design == "adapter_mini-itx" ||
		    case_design == "adapter_flex-atx" || case_design == "adapter_mini-dtx" || case_design == "adapter_dtx" ||
		    case_design == "adapter_micro-atx" || case_design == "adapter_atx" || case_design == "adapter_ssi-ceb" ||
		    case_design == "adapter_ssi-eeb")
		{
		...
		if (accessory_name != "none")
		{
			for (i = [1:11:len(accessory_data[a[0]]) - 1])
			{
				...
				{
					add(type, loc_x, loc_y, loc_z, face, rotation, [ size_x, size_y, size_z ],
	...
	if (view == "model")
	{
		...
		text_indent = [
			0,  -32.5, 4,   0, -20.5, -8, 4, 4, 4,   4,     -12,  -16,  -4, -12.5,
			-8, -4,    -12, 0, 4,     0,  4, 8, -.5, -12.5, -4.5, -8.5, 0,  -8
		];
		ctext_offset = 15;
		ctext_height = 130;
		...
		if (case_design == "panel_nas")
		{
			...
			for (i = [0:1:hd_bays - 1])
			{
				if (hd_reverse == false)
				{
					...
					{
						translate(
						    [ -gap, -(3 * wallthick) - gap + hd_y_position, hd_z_position + (hd_space + 27.1) * i ])
						hd35("portrait", [ false, 0, 0, "default" ]);
						if (pcb_width > 100 || width - 2 * (sidethick + gap) > 101.6)
						{
							translate([
								101.6 - gap + hd_spacer - 9.4, 28.5 - (3 * wallthick) - gap + hd_y_position + 101.6,
								hd_z_position + 6 + (hd_space + 27.1) *
								i
							])
							cableholder_spacer(hd_spacer - 9.4);

							translate([
								101.6 - gap + hd_spacer - 9.4, -31 - (3 * wallthick) - gap + hd_y_position + 101.6,
								hd_z_position + 6 + (hd_space + 27.1) *
								i
							])
							cableholder_spacer(hd_spacer - 9.4);
							...
							translate([
								101.6 - gap + hd_spacer - 9.4, -73 - (3 * wallthick) - gap + hd_y_position + 101.6,
								hd_z_position + 6 + (hd_space + 27.1) *
								i
							])
							cableholder_spacer(hd_spacer - 9.4);
					...
					{
						translate([
							-gap + hd_spacer / 2, -(3 * wallthick) - gap + hd_y_position,
							hd_z_position + (hd_space + 27.1) *
							i
						])
						hd35("portrait", [ false, 0, 0, "default" ]);
						if (pcb_width > 100 || width - 2 * (sidethick + gap) > 101.6)
						{
							...
							translate([
								101.6 - gap + hd_spacer - 9.4, 28.5 - (3 * wallthick) - gap + hd_y_position + 101.6,
								hd_z_position + 6.5 + (hd_space + 27.1) *
								i
							])
							cableholder_spacer(hd_spacer / 2 - 9.4);
				...
				if (hd_reverse == true)
				{
					...
					{
						translate([
							101.6 - gap, -(3 * wallthick) - gap + hd_y_position + 147,
							hd_z_position + (hd_space + 27.1) *
							i
						])
						rotate([ 0, 0, 180 ])
						...
						{
							translate([
								101.6 - gap + hd_spacer - 9.4, 17 - (3 * wallthick) - gap + hd_y_position + 101.6,
								hd_z_position + 6.5 + (hd_space + 27.1) *
								i
							])
							cableholder_spacer(hd_spacer - 9.4);
							...
							translate([
								101.6 - gap + hd_spacer - 9.4, -25 - (3 * wallthick) - gap + hd_y_position + 101.6,
								hd_z_position + 6.5 + (hd_space + 27.1) *
								i
							])
							cableholder_spacer(hd_spacer - 9.4);
							translate([
								101.6 - gap + hd_spacer - 9.4, -84.5 - (3 * wallthick) - gap + hd_y_position + 101.6,
								hd_z_position + 6.5 + (hd_space + 27.1) *
								i
							])
							cableholder_spacer(hd_spacer - 9.4);
					...
					{
						translate([
							101.6 - gap + hd_spacer / 2, -(3 * wallthick) - gap + hd_y_position + 147,
							hd_z_position + (hd_space + 27.1) *
							i
						])
						rotate([ 0, 0, 180 ])
			...
			if (move_rear >= 0)
			{
				fan_model = rear_fan_size == 92   ? "box92x10"
				...
				if (rear_fan == 2)
				{
					...
					{
						translate([
							-1 + (101.6 - rear_fan_size) / 2, 10 - wallthick, rear_fan_position + rear_dualfan_spacing +
							rear_fan_size
						])
						rotate([ 90, 0, 0 ])
						fans(fan_model, [ false, 0, 0, "default" ]);
					...
					if (rear_fan_center == true)
					{
						translate([
							-1 + (101.6 - rear_fan_size) / 2 + (width - 2 * (sidethick + gap) - 101.6) / 2,
							10 - wallthick, rear_fan_position + rear_dualfan_spacing +
							rear_fan_size
						])
						rotate([ 90, 0, 0 ])
						fans(fan_model, [ false, 0, 0, "default" ]);
		...
		if (case_design == "tray" || case_design == "tray_sides" || case_design == "tray_vu5" ||
		    case_design == "tray_vu7")
		{
			if (lower_bottom >= 0)
			{
				difference()
				{
					...
					{
						translate(
						    [ -gap - wallthick - sidethick - 1, depth - 2 * (gap + wallthick), -lower_bottom - 1 ])
						cube([ width + 2 * sidethick + 2, gap + wallthick + 1.01, case_z + 5 ]);
					}
					if (move_leftside < 0)
					{
					...
					{
						translate(
						    [ width - sidethick - 2 * (gap + wallthick), -gap - wallthick - 1, -lower_bottom - 1 ])
			...
			if (case_design == "tray_vu7")
			{
				...
				color("darkgrey", .5) translate(
				    [ -((192.90 - 100) / 2) + (width / 2) - wallthick - gap - 53.5, depth + 11.5, case_z + 27 ])
				rotate([ -15, 0, 180 ])
				hk_speaker();
			}
			if (sbc_off == false)
		...
		if (case_design == "rack")
		{
			...
			for (r = [0:ucount])
			{
				...
				{
					translate([
						-gap - wallthick - 1 + .125 + 75 * (r + 1) + fan_offset + 8, depth - gap,
			...
			if (sbc_off == false)
			{
				for (i = [0:len(rack_bay_sbc) - 1])
				{
					...
					if (rack_bay_sbc[i] != "none" && rack_bay_face[i] == "removable")
					{
						...
						translate([
							pcb_loc_x + bayadj + 75 * (i + 1), pcb_loc_y + wallthick + gap,
		...
		if (accessory_name != "none")
		{
			for (i = [1:11:len(accessory_data[a[0]]) - 1])
			{
				...
				{
					parametric_move_add(type, loc_x, loc_y, loc_z + raise_top, face, rotation, parametric, size, data,
	...
	if (view == "part")
	{
		...
		if (individual_part == "bottom")
		{
			...
			if (case_design == "adapter_mini-stx_thin" || case_design == "adapter_mini-stx" ||
			    case_design == "adapter_mini-itx_thin" || case_design == "adapter_mini-itx" ||
			    case_design == "adapter_flex-atx" || case_design == "adapter_mini-dtx" ||
			    case_design == "adapter_dtx" || case_design == "adapter_micro-atx" || case_design == "adapter_atx" ||
			    case_design == "adapter_ssi-ceb" || case_design == "adapter_ssi-eeb")
			{
			...
			if (bottom_access_panel_enable == true)
			{
				...
				if (access_panel_rotation == 180)
				{
					translate([
						...
						-access_panel_location[1] + access_panel_size[1], 0
					])
					rotate([ 0, 0, access_panel_rotation ])
					access_cover([ access_panel_size[0], -access_panel_size[1], floorthick ], access_panel_orientation);
				}
	...
	else
	{
		if (case_design == "panel_nas")
		{
			echo(width = width + hd_spacer, depth = depth, top = top_height, bottom = bottom_height,
